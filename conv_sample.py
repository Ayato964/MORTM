...
from mortm.train.tokenizer import Tokenizer, get_token_converter_melody_only4_5, TO_TOKEN
...
tokenizer = Tokenizer(get_token_converter_melody_only4_5(TO_TOKEN))

con = MIDI2Seq(tokenizer, "C:/Users/Nagoshi Takaaki.KTHRLab/MIDIdatasets/MMD_MIDI/9/d/6/", TEST_MIDI, program_list=["SAX"])
